                                ...
                                <td>
                                    {
                                        parcel.deliveryStatus === 'driver-assigned' ? <>
                                            <button onClick={() => handleDeliveryStatusUpdate(parcel, 'rider-arriving')}
                                ...
                                <td>
                                    {<>
                                        {parcel.deliveryStatus === 'rider-arriving' && (
                                            <button onClick={() => handleDeliveryStatusUpdate(parcel, 'parcel_picked_up')}
                                                className='btn btn-primary text-black'>Marked as Picked Up</button>
                                        )
                                        }
                                    </>
                                    }
                                    <button onClick={() => handleDeliveryStatusUpdate(parcel, 'parcel_delivered')}
                                        className='btn btn-primary text-black'>Marked as Delivered</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
