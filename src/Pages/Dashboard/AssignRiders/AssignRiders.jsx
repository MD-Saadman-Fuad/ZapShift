...
const AssignRiders = () => {
            ...
            .then(res => {
                if (res.data.modifiedCount) {
                    ...
                    Swal.fire({
                        position: "top-end",
                        icon: "success",
                        title: `Rider ${rider.name} is assigned to parcel ${selectedParcel.parcelName}.`,
    ...
    return (
        <div>
            <h2 className='text-2xl font-bold'>Assign Riders: {parcels.length} parcels pending pickup</h2>
                ...
                <table className="table table-zebra">
                    ...
                    <tbody>
                        {parcels.map((parcel, index) =>
                            <tr key={parcel._id || parcel.id || index}>
                                <th>{index + 1}</th>
